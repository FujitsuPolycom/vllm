...
and the combined runtime used for measurements. Combining the two feature
branches reproduces the measured runtime and test subtrees; documentation
and evidence commits do not identify a separately compiled image.
